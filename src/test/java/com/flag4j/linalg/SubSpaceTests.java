...
class SubSpaceTests {
    ...
    void colSpaceTestCase() {
        ...
        expAEntries = new double[][]{
                {0.002536286923471442, 0.25287887601883857},
                {0.03778044483704439, -0.9668312284180349},
                {-0.9992828454629634, -0.035911694740326364}
        };
        ...
        expBEntries = new CNumber[][]{
                {new CNumber(0.7897307819292936, 0.6134464333944538)},
                {new CNumber(0.0023161628612940388, 0.0018441308442139)}
        };
    ...
    void rowSpaceTestCase() {
        // -------------------- Sub-case 1 --------------------
        expAEntries = new double[][]{
                {0.999488309423674, -0.020218901157440936},
                {-0.01639076956075032, 0.2333428640994127},
                {-0.027464336473866743, -0.8812728776030871}
        };
        expA = new Matrix(expAEntries);
        ...
        // -------------------- Sub-case 2 --------------------
        expBEntries = new CNumber[][]{
                {new CNumber(0.6444662924516938, 0.7627274875602088)},
                {new CNumber(0.03309202724299262, -0.04260158854559634)}
        };
        expB = new CMatrix(expBEntries);
