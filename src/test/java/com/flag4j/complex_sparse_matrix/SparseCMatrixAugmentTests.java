...
class SparseCMatrixAugmentTests {
    ...
    void realSparseAugmentTest() {
        ...
        c = new SparseMatrix(cShape, cEntries, cRowIndices, cColIndices);
    ...
    void complexSparseAugmentTest() {
        ...
        d = new SparseCMatrix(dShape, dEntries, dRowIndices, dColIndices);
