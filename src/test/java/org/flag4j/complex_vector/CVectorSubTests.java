...
class CVectorSubTests {
    ...
    void realSparseEqTestCase() {
        ...
        RealComplexDenseSparseVectorOperations.subEq(a, b);
        assertEquals(exp, a);
        ...
        assertThrows(LinearAlgebraException.class, ()->RealComplexDenseSparseVectorOperations.subEq(a, finalB));
        ...
        assertThrows(LinearAlgebraException.class, ()->RealComplexDenseSparseVectorOperations.subEq(a, finalB1));
    }
