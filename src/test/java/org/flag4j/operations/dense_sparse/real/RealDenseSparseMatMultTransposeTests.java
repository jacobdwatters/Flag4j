package org.flag4j.operations.dense_sparse.real;
...
import static org.flag4j.operations.dense_sparse.coo.real.RealDenseSparseMatrixMultTranspose.multTranspose;
...
class RealDenseSparseMatMultTransposeTests {
    ...
    void matMultTestCase() {
        ...
        exp = A.mult(new CooMatrix(bShape.copy().swapAxes(0, 1), bEntries, colIndices, rowIndices));
