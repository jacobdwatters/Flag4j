package org.flag4j.operations.dense_sparse.real_complex;
...
class RealComplexDenseSparseMatMultTransposeTests {
    ...
    void complexDenseRealSpTestCase() {
        ...
        CMatrix act = new CMatrix(complexDense.numRows, realSp.numRows, RealComplexDenseSparseMatrixMultTranspose.multTranspose(
