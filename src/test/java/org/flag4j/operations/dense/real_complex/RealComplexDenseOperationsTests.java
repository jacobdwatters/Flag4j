...
import static org.flag4j.operations.dense.real_complex.RealComplexDenseOperations.add;
import static org.flag4j.operations.dense.real_complex.RealComplexDenseOperations.sub;
...
class RealComplexDenseOperationsTests {
    ...
    void scaleMultComplex() {
        ...
        assertArrayEquals(expResult, Complex128Operations.scalMult(src2, aC));
    }
}
