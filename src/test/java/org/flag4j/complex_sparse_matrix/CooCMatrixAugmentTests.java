...
class CooCMatrixAugmentTests {
    ...
    void realSparseAugmentTest() {
        ...
        c = new CooMatrixOld(cShape, cEntries, cRowIndices, cColIndices);
    ...
    void complexSparseAugmentTest() {
        ...
        d = new CooCMatrixOld(dShape, dEntries, dRowIndices, dColIndices);
