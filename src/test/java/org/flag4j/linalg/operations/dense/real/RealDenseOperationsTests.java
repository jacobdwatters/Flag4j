...
class RealDenseOperationsTests {
    ...
    void addTestCase() {
        ...
        assertThrows(LinearAlgebraException.class, () -> add(src1, src2, null));
    ...
    void subTestCase() {
        ...
        shape1 = new Shape(src1.length);
        shape2 = new Shape(src2.length);
        assertThrows(LinearAlgebraException.class, () -> sub(src1, src2, act));
        ...
        shape1 = new Shape(src1.length);
        shape2 = new Shape(src2.length);
        assertThrows(LinearAlgebraException.class, () -> sub(src1, src2, null));
    }
