...
class RealComplexDenseSparseMatMultTests {
    ...
    CooMatrixOld ASparse;
    CooVectorOld ACooVector;
    ...
    void matMultTestCase() {
        ...
        shape = new Shape(3, 2);
        BSparseComplex = new CooCMatrixOld(shape, bEntries, rowIndices, colIndices);
        ...
        shape = new Shape(4, 3);
        ASparse = new CooMatrixOld(shape, aSparseEntries, rowIndices, colIndices);
    ...
    void matVecMultTestCase() {
        ...
        ACooVector = new CooVectorOld(2, aSparseEntries, rowIndices);
        bComplexEntries = new CNumber[][]{
                {new CNumber(1.34, 13.4), new CNumber(234.6, 6)},
                {new CNumber(-9.55, 1.9414), new CNumber(9, 1)},
                {new CNumber(0.9923, -985.2), new CNumber(9234)}};
